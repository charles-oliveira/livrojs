...
window.addEventListener('load', () => {
  // geta números aleatórios, entre 1 e 5, para cada moeda
  ...
  // define o texto alternativo das imagens (acessibilidade)
  const alt1_00 = 'Moedas de um real'
  const alt0_50 = 'Moedas de Cinquenta Centavos'
  const alt0_25 = 'Meodas de Vinte e Cinco Centavos'
...
form.addEventListener('submit', e => {
  ...
  const soma = Number(form.soma.value)
